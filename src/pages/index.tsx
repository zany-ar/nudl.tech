      ...
      <Main id="intro">
        ...
        */}
        ...
        <Box textAlign={"center"} mt={"150px !important"}>
          ...
          <br />
          <Text color={"text"}>Some of my public projects.</Text>
          <br />
          <Box>
        ...
        <Box textAlign={"center"} mt={"150px !important"}>
          ...
          <br />
          <Text color={"text"}>Projects which made me smile!</Text>
          <br />
          <br />
        ...
        <Box textAlign={"center"} mt={"150px !important"}>
          ...
          <br />
          <Text color={"text"}>Technologies I use often.</Text>
          <br />
